...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-gray-100 dark:bg-neutral-900 border-b border-gray-300 dark:border-gray-600">
          ...
          <div className="hidden md:flex space-x-6 relative">
            {navLinks.map((link) => (
              <div key={link.name} className="relative group">
                ...
                {link.sublinks && (
                  <div className="absolute left-0 mt-4 w-48 bg-white  dark:bg-neutral-900 rounded-lg shadow-lg py-2 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    {link.sublinks.map((sublink) => (
                      <div key={sublink.name} className="relative group/sub">
                        ...
                        {sublink.sublinks && (
                          <div className="absolute top-0 left-full ml-0 w-48 bg-white  dark:bg-neutral-900 rounded-lg shadow-lg py-2 z-50 opacity-0 invisible group-hover/sub:opacity-100 group-hover/sub:visible transition-all duration-200">
