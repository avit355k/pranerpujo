// src/components/Admin/AddEditPandelForm.jsx
...
const AddPandelForm = ({ setActiveTab, fetchPandels }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:5000/api/pandel/create", data);
      alert("✅ Pandel Added Successfully!");
      fetchPandels();
      setActiveTab("manage");
    } catch (err) {
      console.error(err);
      alert("❌ Error adding pandel");
    }
  };

  return (
    <div className="bg-white dark:bg-neutral-800 p-6 rounded-xl shadow-lg mx-auto">
      <h2 className="text-2xl font-semibold mb-6 text-red-600 text-center">Add New Pandel</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <input
            ...
            required
            className="p-2 border rounded-lg dark:bg-neutral-900 w-full placeholder-gray-400 dark:placeholder-gray-500"
          />
          <input
            type="text"
            name="address"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              onChange={handleChange}
              required
              className="w-1/2 p-2 border rounded-lg dark:bg-neutral-900 placeholder-gray-400 dark:placeholder-gray-500"
            />
            <input
              type="number"
              name="longitude"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <input
            ...
            onChange={handleChange}
            className="p-2 border rounded-lg dark:bg-neutral-900 placeholder-gray-400 dark:placeholder-gray-500"
          />
          <input
            type="text"
            name="railway"
